...
if (isset($_POST['filter'])) {
    $tglDari = strtotime($_POST['tgl_dari']);
    $tglHingga = strtotime($_POST['tgl_hingga']);
    $tglSaatIni = date('d F Y', $tglDari) ." - ". date('d F Y', $tglHingga);
} else {
    $tglSaatIni = date('F Y');
}
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"> Rekap Data Penyewa Periode <span class="text-danger"><?php echo $tglSaatIni ?></span></h4>
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <form action="" method="POST">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <button class="btn btn-sm btn-success" type="submit" name="filter">Filter Data</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                ...
                                <div class="table-responsive">
                                    <table id="example3" class="display" style="min-width: 845px">
                                         ...
                                         // Set default value to current month and year
                                          ...
                                          if (isset($_POST['filter'])) {
                                              ...
                                              if ($tglDari != null || $tglHingga != null) {
                                                  ...
                                                  $getPemesanan = mysqli_query($conn, "SELECT * FROM tb_pemesanan WHERE created_at BETWEEN '$tglDari' AND DATE_ADD('$tglHingga', INTERVAL 1 DAY) AND status_pemesanan !='P' ORDER BY tb_pemesanan.id ASC");
                                              } else {
                                        ...
                                        <tr>
                                            <th colspan="2"><a href="./cetakDataPenyewa.php?tgl_awal=<?php echo $tglDari?>&tgl_akhir=<?php echo $tglHingga?>" target="_blank" class="btn btn-info btn-sm">Cetak Laporan</a></th>
                                            <th></th>
                                            <th></th>
                                            <th></th>
                                            <th></th>
