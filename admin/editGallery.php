                ...
                <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="POST" action="./controller/gallery/update.php" enctype="multipart/form-data">
                                        <?php
                                        $getData = mysqli_query($conn, "SELECT * FROM gallery WHERE id = '$id'");
                                        while ($dataFasilitas = mysqli_fetch_array($getData)) {
                                        ?>
                                        <div class="row">
                                        <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            <label>Photo gallery kost</label>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control input-default " placeholder="Nama Fasilitas" name="judul" value="<?php echo $dataFasilitas['judul']?>">
                                        </div>
                                        </div>
                                       </div>
                                        <?php }?>
                                        <a class="btn btn-sm btn-warning text-white" href="./dataGallery.php">Kembali</a>
